...
<html>
  <head>
   ...
   <title>ESE | Almacen</title>
    ...
    <link rel="shortcut icon" href="../public/img/ese.ico">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>ESE</b> A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ESE</b> ADMIN</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Empleado Ese suroccidente</small>
                </p>
              </li>
              <!-- Menu Footer-->
