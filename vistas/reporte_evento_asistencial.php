            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">REPORTE EVENTO ASISTENCIAL: <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros_s">
                        <form action="" name="formulario_s" id="formulario_s" method="POST">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                <label for="">HC del paciente(*):</label>
                                <input class="form-control" type="text" name="hc_paciente" id="hc_paciente" maxlength="100" placeholder="Número de Historia Clínica del paciente" required>
                            </div>
...
require 'footer.php';
?>
<script src="scripts/reporte_as.js"></script>
